...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, mpu_int_Pin|mpu_fsync_Pin|lcd_command_Pin|lcd_cs_Pin
                          |rfm_cs_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : mpu_int_Pin mpu_fsync_Pin lcd_command_Pin lcd_cs_Pin
                           rfm_cs_Pin */
  GPIO_InitStruct.Pin = mpu_int_Pin|mpu_fsync_Pin|lcd_command_Pin|lcd_cs_Pin
                          |rfm_cs_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
